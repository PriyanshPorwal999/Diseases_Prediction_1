...
diabetes_model = pickle.load(open('D:\C DATA AFTER RAM & SSD INSTALLATION\CODE HISTORY\AICTE INTERNSHIP\Disease Prediction\Random Forest_diabetes_model_tomek.sav', 'rb'))
